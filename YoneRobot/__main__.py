...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ironman.modules." + module_name)
    ...
    if query.data == "ironman_":
        query.message.edit_text(
            text=""" ℹ️ I'm *IRONMAN*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/https://github.com/aman706/ironman2).
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(yone_about_callback, pattern=r"ironman_")
